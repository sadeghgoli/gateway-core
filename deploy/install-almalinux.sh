...
server {
    ...
    listen [::]:443 ssl;
    http2 on;
    server_name map-gateway.sabzevar.ir apisrv-gatewaylogin.sabzevar.ir apisrv-gateway137.sabzevar.ir ${ADMIN_HOST};
...
echo
echo "نصب تمام شد."
echo "  پنل:  https://${ADMIN_HOST}/   یا   http://<IP-سرور>:8002/"
echo "  کاربر: admin"
